...
| Video | Açıklama |
|-------|----------|
| *(yakında eklenecek)* | Zorlu parkur, 5 episode, 8 FPS — Shared Policy modeli — `test_hard_course_pygame_v2.py` |
| *(yakında eklenecek)* | Rastgele parkur, 5 episode, 10 FPS — `visualize_pygame_v2.py` |
...
- **Giriş:** 48 boyutlu observation vektörü (4 drone × 12 lokal obs; VecNormalize ile normalize)
...
### Gözlem Uzayı (Observation — 48 boyut = 4 × 12)

Her drone için 12 boyutlu lokal gözlem:
...
| 8–11 | Engel ray mesafeleri — 4 yön (ileri, sağ, geri, sol); en yakın engel/duvar mesafesi [0, 1] |
